    ...
    const renderMobile = () => {
        return <Box padding="25px" display="flex" flexDirection="column">
            <Cbox borderRadius="8px" style={{ background: '#1D2328' }} pa="51" flexDirection="column" justifyContent="start" alignItems="flex-start">
                ...
                <Cbox fontSize="36px" bold>Roadmap</Cbox>
                <Cbox width="60%" mb="10px" fontSize="14px" >Check out our Roadmap to see what was done far now and what will be come in future in Ariva Wonderland.</Cbox>
                <Cbox mb="60px"><FilterBtn  onClick={()=>navigate('/roadmap')} style={{ padding: '2.62vw 5.96vw', borderRadius: 12, fontSize: '14px', fontWeight: 'bold' }}>Roadmap</FilterBtn></Cbox>
    ...
    const renderWeb = () => {
        return <Box padding="75px 70px 70px 150px" >
            <Cbox borderRadius="8px" style={{ background: '#1D2328' }} pa="51" flexDirection="column" justifyContent="start" alignItems="flex-start">
                ...
                <Cbox fsize="36" bold>Roadmap</Cbox>
                <Cbox width="60%" mb="10px" fsize="14" >Check out our Roadmap to see what was done far now and what will be come in future in Ariva Wonderland.</Cbox>
                <Cbox mb="60px"><FilterBtn onClick={()=>navigate('/roadmap')} style={{ padding: '0.62vw 2.96vw', borderRadius: 12, fontSize: '1.1vw', fontWeight: 'bold' }}>Roadmap</FilterBtn></Cbox>
