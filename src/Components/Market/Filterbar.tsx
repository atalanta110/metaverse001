...
import nftMarket from "../../assets/images/market/nft-market.jpg";
...
const Filterbar: FC<{ results: number }> = (props) => {
  ...
  const renderWeb = () => {
    return (
      <Box className="market_filter_wrapper">
        <Box
          className="market_filter_container"
          style={{ height: 240, marginBottom: 100 }}
        >
          <Box className="market_filter_in">
            ...
            <Box className="market_filter_option">
              ...
              >
                NFTs for sale | {props.results} results
              </TextNormal>
          ...
          <Box className="market_filter_mark_container">
            <Box className="market_filter_mark_content">
              <H style={{ textAlign: "center" }}>
                NFT Market of Ariva Wonderland
              </H>
              <TextNormal style={{ textAlign: "center", fontSize: 16 }}>
                Here you can find and buy all the assets that you want for your
                adventure in <b>Ariva Wonderland</b>
              </TextNormal>
            </Box>
          </Box>
        </Box>
  ...
  const renderMobileMarket = () => {
    return (
      <Box
        className="mobile_market_filter_container"
        display="flex"
        flexDirection="column"
      >
        <Box className="mobile_market_filter_mark_container">
          <Box className="mobile_market_filter_mark_content">
            <H mode="mobile" style={{ textAlign: "center" }}>
              NFT Market of Ariva Wonderland
            </H>
            <TextNormal style={{ textAlign: "center", fontSize: 14 }}>
              Here you can find and buy all the assets that you want for your
              adventure in <b>Ariva Wonderland</b>
            </TextNormal>
          </Box>
        ...
        <Box
          ...
          alignItems="center"
          style={{ padding: "16px 40px", background: "#2A2D37", marginTop: -5 }}
        >
          <TextNormal
          ...
          {/* <Box className="market_filter_option_btns">
            <FilterBtn style={{ marginLeft: 10 }}>
              Filters
              <img src={filterIcon} style={{ marginLeft: 5 }} />
            </FilterBtn>
            <NewestBtn style={{ marginLeft: 10 }}>
              Newest
  ...
  const renderMobileFilter = () => {
    return (
      <Box className="mobile_market_filter">
        <NewestBtn onClick={() => setOpenMobileFilter(false)}>
          <img src={arrowleft} style={{ marginRight: 10 }} />
          Back
        </NewestBtn>
