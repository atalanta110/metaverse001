...
const TravelAround = () => {
  ...
  const renderWeb = () => {
    return (
      <Cbox
        ...
        width="calc(100% - 12vw)"
      >
        <Cbox fsize="40" color="#C9F938" bold cmb="11">
          Ariva Wonderland
        </Cbox>
        <Cbox fsize="22" bold cmb="17">
          Travel around the Ariva Universe
        </Cbox>
        <Cbox fsize="20" cmb="30">
        ...
        <Cbox>
          ...
          >
            <img src={playico} className="player_ico" width={12} /> Watch the
            trailer
          </CustomBtn>
        </Cbox>
        <Cbox position="absolute"></Cbox>
  ...
  const renderMobile = () => {
    return (
      <Cbox
        className="mobile_travel_around_container"
        mobile
        pat="220"
        par="15"
        pal="15"
      ...
      >
        ...
        <Cbox mode="mobile" lineHeight="8vw" mobile fsize="16" bold>
          Travel around the Ariva Universe
        </Cbox>
        <Cbox mode="mobile" mobile fsize="12" cmb="24">
          Future in the past, past in the future
        </Cbox>
