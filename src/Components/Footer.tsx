            ...
            <Box className="footer">
                <Grid container spacing={4}>
                    ...
                    <Grid item md={4} className="flex items-start justify-start" flexDirection={'column'}>
                        ...
                        <TextNormal style={{cursor: 'pointer'}} onClick={()=>navigate('/map')}>Map</TextNormal>
                        <TextNormal style={{cursor: 'pointer'}} onClick={()=>navigate('/market')}>Market</TextNormal>
                        <TextNormal style={{cursor: 'pointer'}} onClick={()=>navigate('/roadmap')}>Roadmap</TextNormal>
                        <TextNormal style={{cursor: 'pointer'}}><a target="_blank" href='https://ariva.zendesk.com/hc/en-us/requests/new?ticket_form_id=4424648480401'>Contact Us</a></TextNormal>
                    </Grid>
                    <Grid item md={5} className="flex flex-col items-start justify-start" flexDirection={'column'}>
                        <Box display={'flex'} flexDirection="row" justifyContent={'center'} alignItems="center" style={{ marginBottom: 20 }} >
                            ...
                            <TextNormal style={{ fontSize: 22,fontWeight:"bold" }}>Ariva Wonderland</TextNormal>
                        </Box>
                        <TextNormal style={{ marginBottom: 20 }}>Ariva is changing the future of tourism. </TextNormal>
