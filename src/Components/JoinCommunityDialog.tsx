    ...
    return (
      ...
      >
        ...
        >
          ...
          <Cbox cmb="13" fsize="14">
            Stay tuned with us to get the last updates about Ariva Wonderland.
          </Cbox>
          <Cbox cmb="28">
            <Cbox cmr="8">
              <a
                href="https://www.instagram.com/ArivaWonderland/"
                target="_blank"
              >
                <img src={Instagram} style={{ width: "4.55vw" }} alt="" />
              </a>
            </Cbox>
            <Cbox cmr="8">
              <a href="https://twitter.com/ArivaWonderland" target="_blank">
                <img src={Twitter} style={{ width: "4.55vw" }} alt="" />
              </a>
            </Cbox>
            <Cbox cmr="8">
              <a href="https://t.me/ariva_arv" target="_blank">
                <img src={Telegram} style={{ width: "4.55vw" }} alt="" />
              </a>
            </Cbox>
            <Cbox cmr="8">
              <a href="https://discord.gg/nnFn8HgPhv" target="_blank">
                <img src={Discord} style={{ width: "4.55vw" }} alt="" />
              </a>
            </Cbox>
            <Cbox cmr="8">
              <a
                href="https://www.facebook.com/ArivaWonderland/"
                target="_blank"
              >
                <img src={Facebook} style={{ width: "4.55vw" }} alt="" />
              </a>
            </Cbox>
          </Cbox>
          <Cbox fsize="14">
          Follow other Ariva projects{" "}
            <u style={{ paddingRight: 5, paddingLeft:5 }}><a href="https://twitter.com/ArivaCoin" target="_blank">Twitter</a></u>,
            ...
            <u style={{ paddingRight: 5 }}><a href="https://www.reddit.com/r/ArivaCoin" target="_blank">Reddit</a></u>
          </Cbox>
        </Cbox>
      </Cbox>
    );
      ...
      >
        ...
        >
          ...
          <Cbox mobile mb="28px">
            ...
            <Cbox mobile cmr="8">
              <a href="https://twitter.com/ArivaWonderland" target="_blank">
                <img src={Twitter} style={{ width: "42px" }} alt="" />
              </a>
            </Cbox>
            <Cbox mobile cmr="8">
              <a href="https://t.me/ariva_arv" target="_blank">
                <img src={Telegram} style={{ width: "42px" }} alt="" />
              </a>
            </Cbox>
            <Cbox mobile cmr="8">
              <a href="https://discord.gg/nnFn8HgPhv" target="_blank">
                <img src={Discord} style={{ width: "42px" }} alt="" />
              </a>
            </Cbox>
            <Cbox mobile cmr="8">
              <a
          ...
          <Box fontSize="14px" lineHeight="110%" pr="60px">
            Follow other Ariva projects{" "}
            <u style={{ paddingRight: 5 }}><a href="https://twitter.com/ArivaCoin" target="_blank">Twitter</a></u>,
            <u style={{ paddingRight: 5 }}><a href="https://www.instagram.com/arivacoin/" target="_blank">Instagram</a></u>,
            <u style={{ paddingRight: 5 }}><a href="https://www.facebook.com/arivadigital" target="_blank">Facebook</a></u>,
            <u style={{ paddingRight: 5 }}><a href="https://www.reddit.com/r/ArivaCoin" target="_blank">Reddit</a></u>
          </Box>
